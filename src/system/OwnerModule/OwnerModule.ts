// src/system/OwnerModule/OwnerModule.ts
 ...
 * OwnerModule
 * 
 * Globalny moduł odpowiadający za wszystkie sprawdzenia uprawnień właścicieli.
 * Obsługuje:
 *  - Bot Ownera (konto posiadające pełne prawa administracyjne)
 *  - Discord Guild Ownera (właściciel serwera)
 * 
 * Udostępnia metody do weryfikacji i rzucania błędów, jeśli użytkownik nie ma uprawnień.
 */
